/**
* Форматирует JSON на странице в виде таблицы, похожей на var_dump() в PHP.
* Может быть помещён на панель управления браузера и вызываться при необходимости.
*/

/* @use https://github.com/jamespadolsey/prettyPrint.js */
/*
...
console.log( t );
*/
t = t.replace("<pre>", "").replace("</pre>", "");
var o = null;
try {
    eval( "o = (" + t + ");" );
} catch (ex) {
    document.body.insertBefore( "Don't parse this as JSON > |" + t + "|", document.body.firstChild );
}
if (o !== null) {
    var p = prettyPrint( o, { expanded: false, forceObject: true, maxDepth: 5 } );
